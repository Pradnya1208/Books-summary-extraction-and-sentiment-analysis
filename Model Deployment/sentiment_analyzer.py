...
def find_sentiment(summary_dataframe, summ_text):
  ...
  if emotion_pn.raw_emotion_scores['positive'] > emotion_pn.raw_emotion_scores['negative']:
      y_pred2 = "Positive"
  elif emotion_pn.raw_emotion_scores['positive'] < emotion_pn.raw_emotion_scores['negative']:
      y_pred2="Negative"
  else:
      y_pred2="Neutral"
